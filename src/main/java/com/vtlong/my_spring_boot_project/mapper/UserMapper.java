...
public interface UserMapper {
    ...
    List<UserResponseDto> mapUsersToUserResponseDtos(List<User> users);

    @Mapping(target = "id", ignore = true)
    @Mapping(target = "createdAt", ignore = true)
    @Mapping(target = "updatedAt", ignore = true)
    User mapCreateUserRequestDtoToUser(CreateUserRequestDto createUserRequestDto);

    @Mapping(target = "id", ignore = true)
    @Mapping(target = "password", ignore = true)
    @Mapping(target = "createdAt", ignore = true)
    @Mapping(target = "updatedAt", ignore = true)
    void mapUpdateUserRequestDtoToUser(UpdateUserRequestDto updateUserRequestDto, @MappingTarget User user);
}
